...
class ShowcaseController {
  ...
  Size get rootWidgetSize => showCaseWidgetState.rootWidgetSize;

  /// Render box for the root widget
  RenderBox get rootRenderObject => showCaseWidgetState.rootRenderObject;
  ...
  void updateControllerData() {
    ...
    final containerRenderBox = containerKey?.currentContext?.findRenderObject() as RenderBox?;

    final size = rootWidgetSize;
    ...
    getToolTipWidget = isScrollRunning
        ...
        : [
            ...
            TooltipBaseWidget.resolve(
              ...
              alignedFromParent: config.alignedFromParent,
              arrowPainterBuilder: config.arrowPainterBuilder,
              tooltipBackgroundColor: config.tooltipBackgroundColor,
              textColor: config.textColor,
              showArrow: config.showArrow,
              arrowVerticalMargin: config.arrowVerticalMargin,
